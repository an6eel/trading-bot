from models.stock_model import StockModelUpdate, StockModelDB, StockModelCreate, TrainingStatus, TrainingType
...
async def create_model(db: AsyncIOMotorCollection, model: StockModelCreate, type: TrainingType) -> StockModelDB:
